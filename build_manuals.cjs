...
// 1. THAI MARKDOWN
const thMarkdown = `# คู่มือการใช้งานระบบ Lineage2M Clan Hub (v1.3.0)
...
| :--- | :---: | :--- |
| **Owner (เจ้าของ)** | 👑 | มีสิทธิ์สูงสุด ควบคุมระบบทั้งหมด ปรับเปลี่ยนตำแหน่งผู้เล่น อนุมัติสมาชิกใหม่ อนุมัติคำขออัปเดตค่าพลัง (CP) และใช้งาน **ศูนย์รีเซ็ตระบบ (Reset Center)** ได้ผู้เดียว |
| **Admin (ผู้ดูแล)** | 🛡️ | เพิ่มไอเทมในคลัง, จัดการคิวไอเทม, แจกจ่ายไอเทม, อนุมัติสมาชิกใหม่, อนุมัติคำขออัปเดตค่าพลัง (CP), และฝาก-ถอนเพชรในคลังกลางได้ |
| **Member (สมาชิก)** | ⚔️ | ดูรายการไอเทมในคลัง, ลงชื่อขอรับไอเทม (Claim) ที่พลัง CP ผ่านเกณฑ์, ดูคิวไอเทม, ส่งคำขออัปเดตค่าพลังของตนเอง, และดูรายชื่อสมาชิกในกิลด์ |
