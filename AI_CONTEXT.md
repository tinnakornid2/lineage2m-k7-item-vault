...
> **สำหรับ AI ในการทำความเข้าใจโปรเจกต์อย่างรวดเร็วและครบถ้วน 100% (เวอร์ชันปัจจุบัน: v1.4.0)**
...
- ด้านล่างสุดของ `Sidebar.tsx` แสดงข้อความ:
  ...
  - ป้ายแสดงเวอร์ชันระบบ: **`v1.4.0`** (พร้อมจุดไฟสีเขียวกระพริบ)
- จุดแสดงเวอร์ชันทั้งหมดในระบบ (`Sidebar.tsx`, `Navbar.tsx`, `LoginScreen.tsx`, `package.json`) ต้องตรงกันเสมอ (ปัจจุบันคือ `v1.4.0`)
