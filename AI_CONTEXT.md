...
│       ├── Sidebar.tsx          # แถบเมนูซ้าย + เมนูมือถือหลักของระบบ แสดงข้อมูลโปรไฟล์และปุ่มขออัปเดต CP
│       ├── DashboardView.tsx    # หน้าแดชบอร์ด: ยอดเพชร, ไอเทมเปิดเคลม, คิวไอเทม, ไทม์ไลน์เพชร
│       ├── VaultView.tsx        # หน้าคลังไอเทมบอส: เพิ่มไอเทม, ควิกไอเทม, สแกน OCR (รองรับ Ctrl+V)
