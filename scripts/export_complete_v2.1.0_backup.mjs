...
const backupPayload = {
  version: 'v2.1.0',
  tag: 'v2.1.0-complete-stable',
  exportedAt: new Date().toISOString(),
  description: 'Lineage2M Clan Hub Complete System State Backup',
  metrics: {
...
const targetFile = path.join(backupsDir, 'complete_snapshot_v2.1.0.json');
