...
const backupPayload = {
  version: 'v2.5.0',
  tag: 'v2.5.0-discord-webhook-standard-item-only',
  exportedAt: new Date().toISOString(),
  description: 'Lineage2M Clan Hub Complete System State Backup v2.5.0 (with Rule 5: Discord Webhook Option 1 Only, 100% English for Discord, Item-Only Notifications, 2-line ANSI Code Block, Completely Removed Hunters Line, No Duplicate Title, Real Item Artwork, Role-based Password Management, Payment Status Tracking on Distributed Items with Vault Payment Confirmation, Thai Stat Subtitles in Parentheses with Clean Input Placeholders, and 100% Bilingual Support)',
  metrics: {
...
const targetFile = path.join(backupsDir, 'complete_snapshot_v2.5.0.json');
