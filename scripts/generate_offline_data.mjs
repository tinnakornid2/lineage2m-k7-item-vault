...
const fileContent = `import { User, ClanGroup, QueueItem } from '../types';
...
export const REAL_BACKUP_QUEUES: QueueItem[] = ${JSON.stringify(queues, null, 2)};
`;

fs.writeFileSync(outFile, fileContent, 'utf8');
console.log(`✅ Generated ${outFile} with ${users.length} users, ${clans.length} clans, and ${queues.length} queues`);
