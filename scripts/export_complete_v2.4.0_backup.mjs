...
const backupPayload = {
  version: 'v2.4.0',
  tag: 'v2.4.0-role-passwords-payment-tracking-stable',
  exportedAt: new Date().toISOString(),
  description: 'Lineage2M Clan Hub Complete System State Backup v2.4.0 (with Role-based Password Management, Individual & Auto Notification Cleanup, Payment Status Tracking on Distributed Items with Vault Payment Confirmation, Thai Stat Subtitles in Parentheses with Clean Input Placeholders, and 100% Bilingual Support)',
  metrics: {
...
const targetFile = path.join(backupsDir, 'complete_snapshot_v2.4.0.json');
