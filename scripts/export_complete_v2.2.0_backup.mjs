...
const backupPayload = {
  version: 'v2.2.0',
  tag: 'v2.2.0-discord-templates-stable',
  exportedAt: new Date().toISOString(),
  description: 'Lineage2M Clan Hub Complete System State Backup v2.2.0 (with Discord Templates, ANSI Fonts, and Image Delivery)',
  metrics: {
...
const targetFile = path.join(backupsDir, 'complete_snapshot_v2.2.0.json');
